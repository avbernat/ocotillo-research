...
slope <- diff(y) / diff(x)
int <- y[1] - slope * x[1]
plot(x, y, col="grey", ylim=c(0,40))
points(x, y3, col="grey")
points(x, y4, col="grey")
points(x, y5, col="grey")
points(x, y6, col="grey")
points(x, y7, col="grey")
points(x, y8, col="grey")
points(x, y9, col="grey")
points(x, y10, col="grey")

points(x, y11, col="grey")
points(x, y12, col="grey")
points(x, y13, col="grey")
points(x, y14, col="grey")
points(x, y15, col="grey")
points(x, y16, col="grey")
points(x, y17, col="grey")
points(x, y18, col="grey")
points(x, y19, col="grey")
points(x, y20, col="grey")

points(x, y21, col="blue")
points(x, y22, col="blue")
points(x, y23, col="blue")
points(x, y24, col="blue")
points(x, y25, col="blue")
points(x, y26, col="blue")
points(x, y27, col="blue")
