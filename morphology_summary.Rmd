...
m3 = lm(logCirc ~ X1m_Num4, data=ocos) # Although significant, thi is not a meaningful number in this context.
...
```{r}
summary_table = round(cbind(c(delta1, delta2, delta3), c(me1, me2, me3), c(weight1, weight2, weight3)),3)
summary_table
```
