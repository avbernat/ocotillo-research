...
equations = rename_regformula(equations, "logNB", "Circ_c", "COMP_plant_b", "COMP_dis_c", "Watershed_c")
...
equations = c(eq1, eq2, eq3, eq4)
equations = rename_regformulaME(equations, "Length_c", "Height_c", "T1m_NumNonshrub", "1m_shrub2non", "Tree", "seg_num")
