...
# Best fit model summary
cf <- round(coef(m1), 2) 
eqNN.B <- paste0("logIntraD = ", cf[1],
             ifelse(sign(cf[2])==1, " + ", " - "), abs(cf[2]), " NBranch_c",
             ifelse(sign(cf[3])==1, " + ", " - "), abs(cf[3]), " Inter_Dis_c",
             ifelse(sign(cf[4])==1, " + ", " - "), abs(cf[4]), " Elevation_c",
             ifelse(sign(cf[5])==1, " + ", " - "), abs(cf[5]), " NBranch_c*Inter_Dis_c")

commentNN.B = "Elevation_c and NBranch_c*Inter_Dis_c"
...
# Best fit model summary
cf <- round(coef(m1), 3) 
eqC <- paste0("logInterD = ", cf[1],
             ifelse(sign(cf[2])==1, " + ", " - "), abs(cf[2]), " Arroyo_c")

commentC = "Arroyo_c is marginally significant (p=0.054)"
